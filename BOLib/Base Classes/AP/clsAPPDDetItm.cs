...
{
    /// <summary>
    /// Summary description for APPDDetItm.
    /// </summary>
    [Serializable]
    public class APPDDetItm : DocSalePur, IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public APPDDetItm Clone()
        {
            APPDDetItm objCopy = (APPDDetItm)this.MemberwiseClone();
            return objCopy;
        }
