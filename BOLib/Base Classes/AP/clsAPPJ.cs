...
{
    /// <summary>
    /// Summary description for APPJ.
    /// </summary>
    [Serializable]
    public class APPJ : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(APPJ_PropertyChanged);
        }
        void APPJ_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public APPJ Clone()
        {
            APPJ objCopy = (APPJ)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static APPJ Get(int? docKey)
        {
            APPJ child = new APPJ();
        ...
        internal static APPJ Get(IDataReader dr)
        {
            APPJ child = new APPJ();
            child.Fetch(dr);
            return child;
        }
        internal static APPJ Get(SqlConnection cn, Criteria criteria)
        {
            APPJ child = new APPJ();
        ...
        internal bool Fetch(IDataReader dataReader)
			{               
                ...
                _ApproveDate = dataReader["ApproveDate"] == DBNull.Value ? _ApproveDate : (DateTime?)dataReader["ApproveDate"];				
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "APPJ_Validation";
