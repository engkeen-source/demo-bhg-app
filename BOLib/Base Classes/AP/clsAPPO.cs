...
{
    /// <summary>
    /// Summary description for APPO.
    /// </summary>
    [Serializable]
    public class APPO : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(APPO_PropertyChanged);
        }
        void APPO_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            this.NotifyPropertyChanged(e.PropertyName);
        }
        public APPO Clone()
        {
            APPO objCopy = (APPO)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static APPO Get(int? docKey)
        {
            APPO child = new APPO();
        ...
        public DateTime? DocPrmDate
        {
            ...
            set
            {
                ...
                //NotifyPropertyChanged("DocPrmDate"); //Unbound field not saving
            }
        }
        public DateTime? DocReqDate
        {
            ...
            set
            {
                ...
                //NotifyPropertyChanged("DocReqDate");  //Unbound field not saving
            }
        }
        ...
        public decimal DocCsgTotal
        {

            get
            {
                return this._DocCsgTotal;
            }
            set
            {
                this._DocCsgTotal = value;
                NotifyPropertyChanged("DocCsgTotal");
            }
        }
        #endregion
        ...
        internal static APPO Get(IDataReader dr)
        {
            APPO child = new APPO();
            child.Fetch(dr);
            return child;
        }
        internal static APPO Get(SqlConnection cn, Criteria criteria)
        {
            APPO child = new APPO();
        ...
        internal bool Fetch(IDataReader dataReader)
			{               
				...
				_DocDate = dataReader["DocDate"] == DBNull.Value ? Convert.ToDateTime("01-jan-1900 12:00:00 am") : (DateTime )dataReader["DocDate"];				
                ...
                _DocCsgTotal = dataReader["DocCsgTotal"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocCsgTotal"];
                _DocReqDate = dataReader["ItmReqDate"] == DBNull.Value ? DateTime.Today : (DateTime?)dataReader["ItmReqDate"];
                _DocPrmDate = dataReader["ItmPrmDate"] == DBNull.Value ? DateTime.Today : (DateTime?)dataReader["ItmPrmDate"];
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "APPO_Validation";
