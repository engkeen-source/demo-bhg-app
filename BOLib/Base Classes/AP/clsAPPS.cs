...
namespace BOLib
{
    ...
    /// </summary>
    [Serializable]
    public class APPS : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(APPS_PropertyChanged);
        }

        void APPS_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public APPS Clone()
        {
            APPS objCopy = (APPS)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static APPS Get(int? docKey)
        {
            APPS child = new APPS();
        ...
        internal static APPS Get(IDataReader dr)
        {
            APPS child = new APPS();
            child.Fetch(dr);
            return child;
        }
        internal static APPS Get(SqlConnection cn, Criteria criteria)
        {
            APPS child = new APPS();
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "APPS_Validation";
