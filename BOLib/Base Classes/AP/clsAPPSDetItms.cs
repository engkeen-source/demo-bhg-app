...
{
    /// <summary>
    /// Summary description for APPSDetItms.
    /// </summary>
    [Serializable]
    public class APPSDetItms : DataTable
    {
        #region +++  Constructor  +++
        ...
        public APPSDetItms(SqlConnection cn)
        {
        ...
        internal bool Fetch_APPDDetItm(SqlConnection cn, Criteria criteria)
        {
            bool retValue = false;
            using (SqlCommand cm = cn.CreateCommand())
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "APPDDetItm_CreateDoc";
        ...
        internal bool Delete(SqlConnection cn, Criteria criteria, out string msgID)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "APPSDetItm_Delete";
