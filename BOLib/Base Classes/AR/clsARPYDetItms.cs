...
{
    /// <summary>
    /// Summary description for ARPYDetItms.
    /// </summary>
    [Serializable]
    public class ARPYDetItms : DataTable
    {
        ...
        public ARPYDetItms(SqlConnection cn)
        {
        ...
        public class Criteria
        {
            ...
            public Criteria(int? GUID, int? CodeKey, int? DocKey, int? ConKey, int? UserKey, int? ConKeyChange,string ConNm, int? Option)
            {
                _option = Option;
                _GUID = GUID;
                _CodeKey = CodeKey;
        ...
        {           
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                cm.Parameters.AddWithValue("@pCVNm", criteria._ConNm);
