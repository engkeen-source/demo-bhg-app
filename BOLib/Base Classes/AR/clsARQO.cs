...
{
	/// <summary>
	/// Summary description for ARQO.
	/// </summary>
	[Serializable]
	public class ARQO :Document, INotifyPropertyChanged
	{
        #region +++  Local variables declaration for the class +++

        internal DateTime? _DocDateValid;
        ...
        internal DateTime? _DocEnquiryDate;
        internal int? _DocQuoteStatus;
        internal string _DocQuoteReason;
        ...
        internal bool _IsKPIPotentialPrj;
        //private int? _listDefaultDateRange;
        ...
        {
            this.Clear();
            base.PropertyChanged += new PropertyChangedEventHandler(ARQO_PropertyChanged);
        }
        void ARQO_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        private void Clear()
        {
            ...
            this._DocTermKey = 0;
            this._DocEnquiryDate = null;
            this._DocQuoteStatus = null;
            this._DocQuoteReason = string.Empty;
            this._DocBAddrStreet = string.Empty;
            this._DocBAddrPOBox = string.Empty;
            this._DocBAddrCity = string.Empty;
            this._DocBAddrState = string.Empty;
            this._DocBAddrZipCode = string.Empty;
            this._DocBAddrCountry = string.Empty;
            this._DocBAddrRegion = string.Empty;
            this._DocBAddrAttn = string.Empty;
            this._DocBAddrTel1 = string.Empty;
            this._DocBAddrTel2 = string.Empty;
            this._DocBAddrFax = string.Empty;
            this._DocBAddrEmail = string.Empty;
            this._DocSAddrStreet = string.Empty;
            this._DocSAddrPOBox = string.Empty;
            this._DocSAddrCity = string.Empty;
            this._DocSAddrState = string.Empty;
            this._DocSAddrZipCode = string.Empty;
            this._DocSAddrCountry = string.Empty;
            this._DocSAddrRegion = string.Empty;
            this._DocSAddrAttn = string.Empty;
            this._DocSAddrTel1 = string.Empty;
            this._DocSAddrTel2 = string.Empty;
            this._DocSAddrFax = string.Empty;
            this._DocSAddrEmail = string.Empty;
            this._DocShipName = string.Empty;
            this._DocShipMark = string.Empty;
            this._DocShipKey = null;
            this._DocShipDate = DateTime.Today.Date;
            this._DocCustPONum = string.Empty;
            this._DocQONum = string.Empty;
            this._DocSONum = string.Empty;
            this._DocDONum = string.Empty;
            this._DocIVNum = string.Empty;
            this._DocPONum = string.Empty;
            this._DocPDNum = string.Empty;
            this._DocBLNum = string.Empty;
            this._DocRemDelivery = string.Empty;
            this._DocRemPrice = string.Empty;
            this._DocRemValidity = string.Empty;
            this._DocRemPayment = string.Empty;
            this._DocPermitNum = string.Empty;
            this._DocGoodsDestination = string.Empty;
            this._DocCountryOrigin = string.Empty;
            this._DocRemAdditional1 = string.Empty;
            this._DocRemAdditional2 = string.Empty;
            this._DocRemAdditional3 = string.Empty;
            this._DocRemAdditional4 = string.Empty;
            this._DocSubTotal = 0;
            this._DocOverallDisAcc = 0;
            ...
            this._DocHome = 0;
            this._DocCountryRate = 1;
            this._DocTaxTotalLocal = 0;            
            this._ShowEnquiryForm = false;
            this._isDirty = false;
            this._IsKPIPotentialPrj = false;
        }
        public static ARQO Get(int? docKey)
        {           
            ARQO child = new ARQO();
        ...
        public ARQO Clone()
        {
            ...
            ARQO objCopy = (ARQO)this.MemberwiseClone();
        ...
        public DateTime? DocDateValid
        {
            get
            {
                return this._DocDateValid;
            }
            set
            {
                this._DocDateValid = value;
                NotifyPropertyChanged("DocDateValid");
            }
        }
        ...
        public DateTime? DocEnquiryDate
        {
            get
            {
                return this._DocEnquiryDate;
            }
            set
            {
                this._DocEnquiryDate = value;
                NotifyPropertyChanged("DocEnquiryDate");
            }
        }

        public int? DocQuoteStatus
        {
            get
            {
                return this._DocQuoteStatus;
            }
            set
            {
                this._DocQuoteStatus = value;
                NotifyPropertyChanged("DocQuoteStatus");
            }
        }

        public string DocQuoteReason
        {
            get
            {
                return this._DocQuoteReason;
            }
            set
            {
                this._DocQuoteReason = value;
                NotifyPropertyChanged("DocQuoteReason");
            }
        }
        ...
        public bool IsKPIPotentialPrj
        {

            get
            {
                return this._IsKPIPotentialPrj;
            }
            set
            {
                this._IsKPIPotentialPrj = value;
                NotifyPropertyChanged("IsKPIPotentialPrj");
            }
        }
        ...
        //        NotifyPropertyChanged("ListDefaultDateRange");
        //    }
        //}
		...
		#region Criteria
			...
			internal class Criteria
			{
                ...
                public int? _NewDocKey = null; // added by thettm on 29 jan 2018
            internal Criteria()
				{
				}
				...
				{
					_DocKey = DocKey;
                    _DocCodeKey = (int)GEnum.SystemCode.Quotation;
                    _option = Option;
                    
				}
                internal Criteria(int DocCodeKey, int? Option)
                {
        ...
        internal bool Fetch(Criteria criteria)
			...
			internal static ARQO Get(IDataReader dr)
			{
				ARQO child = new ARQO();
				child.Fetch(dr);
				return child;
			}
            internal static ARQO Get(SqlConnection cn, Criteria criteria)
            {
                ARQO child = new ARQO();
			...
			{                
                ...
                _DocDateValid = dataReader["DocDateValid"] == DBNull.Value ? null : (DateTime?)dataReader["DocDateValid"];
                ...
                _DocConID = dataReader["DocConID"] == DBNull.Value ? string.Empty : dataReader["DocConID"].ToString();
                ...
                _DocAccID = dataReader["DocAccID"] == DBNull.Value ? string.Empty : dataReader["DocAccID"].ToString(); ;
                _DocAccDes = dataReader["DocAccDes"] == DBNull.Value ? string.Empty : dataReader["DocAccDes"].ToString(); ;
                ...
                _DocEnquiryDate = dataReader["DocEnquiryDate"] == DBNull.Value ? null : (DateTime?)dataReader["DocEnquiryDate"];
                _DocQuoteStatus = dataReader["DocQuoteStatus"] == DBNull.Value ? null : (int?)dataReader["DocQuoteStatus"];
                _DocQuoteReason = dataReader["DocQuoteReason"] == DBNull.Value ? string.Empty : dataReader["DocQuoteReason"].ToString();
                ...
                _DocSubTotal = dataReader["DocSubTotal"] == DBNull.Value ? null : (decimal?)dataReader["DocSubTotal"];
                _DocOverallDisAcc = dataReader["DocOverallDisAcc"] == DBNull.Value ? null : (int?)dataReader["DocOverallDisAcc"];
                _DocOverallDisAccDes = dataReader["DocOverallDisAccDes"] == DBNull.Value ? string.Empty : dataReader["DocOverallDisAccDes"].ToString(); ;
                _DocOverallDisAccID = dataReader["DocOverallDisAccID"] == DBNull.Value ? string.Empty : dataReader["DocOverallDisAccID"].ToString(); ;
                _DocOverallDisRate = dataReader["DocOverallDisRate"] == DBNull.Value ? null : (decimal?)dataReader["DocOverallDisRate"];
                _DocOverallDisAmt = dataReader["DocOverallDisAmt"] == DBNull.Value ? null : (decimal?)dataReader["DocOverallDisAmt"];
                _DocTotalAfterDis = dataReader["DocTotalAfterDis"] == DBNull.Value ? null : (decimal?)dataReader["DocTotalAfterDis"];
                _DocTaxGrpKey = dataReader["DocTaxGrpKey"] == DBNull.Value ? null : (int?)dataReader["DocTaxGrpKey"];
                _DocTaxGrpRate = dataReader["DocTaxGrpRate"] == DBNull.Value ? null : (decimal?)dataReader["DocTaxGrpRate"];
                _DocTaxTotal = dataReader["DocTaxTotal"] == DBNull.Value ? null : (decimal?)dataReader["DocTaxTotal"];
                ...
                _DocHomeSubTotal = dataReader["DocHomeSubTotal"] == DBNull.Value ? null : (decimal?)dataReader["DocHomeSubTotal"];
                _DocHomeTaxTotal = dataReader["DocHomeTaxTotal"] == DBNull.Value ? null : (decimal?)dataReader["DocHomeTaxTotal"];
                ...
                _DocTaxTotalLocal = dataReader["DocTaxTotalLocal"] == DBNull.Value ? null : (decimal?)dataReader["DocTaxTotalLocal"];
                ...
                _IsKPIPotentialPrj = dataReader["IsKPIPotentialPrj"] == DBNull.Value ? false : (bool)dataReader["IsKPIPotentialPrj"];
			...
			internal bool Insert(SqlConnection cn)
			{
                ...
                using (SqlCommand cm = cn.CreateCommand())
                {
                    ...
                    if (_DocDateValid == null)
                        cm.Parameters.AddWithValue("@DocDateValid", DBNull.Value);
                    else
                        cm.Parameters.AddWithValue("@DocDateValid", _DocDateValid);
                    if (_DocType == null)
                    ...
                    if (_DocEnquiryDate == null)
                        cm.Parameters.AddWithValue("@DocEnquiryDate", DBNull.Value);
                    else
                        cm.Parameters.AddWithValue("@DocEnquiryDate", _DocEnquiryDate);
                    if (_DocQuoteStatus == null)
                        cm.Parameters.AddWithValue("@DocQuoteStatus", DBNull.Value);
                    else
                        cm.Parameters.AddWithValue("@DocQuoteStatus", _DocQuoteStatus);
                    if (_DocQuoteReason == null)
                        cm.Parameters.AddWithValue("@DocQuoteReason", DBNull.Value);
                    else
                        cm.Parameters.AddWithValue("@DocQuoteReason", _DocQuoteReason);
			...
			internal bool Validation(SqlConnection cn, Criteria criteria,bool isNew)
			{
                ...
                try
                {
                    ...
                    {
                        cm.CommandType = CommandType.StoredProcedure;
                        cm.CommandText = "ARQO_Validation";
