...
{
	/// <summary>
	/// Summary description for ARQODetItm.
	/// </summary> 
	[Serializable]
	public class ARQODetItm :DocSalePur, IDataErrorInfo,INotifyPropertyChanged
	{
        ...
        public ARQODetItm Clone()
        {
            ARQODetItm objCopy = (ARQODetItm)this.MemberwiseClone();
            return objCopy;
        }
		...
		internal static ARQODetItm Get(IDataReader dr, out string msgID)
		{
			msgID = "RecordGetFail";
			ARQODetItm child = new ARQODetItm();
		...
		internal bool Fetch(IDataReader dataReader, out string msgID)
		{
            ...
            _ItmAccID =dataReader["ItmAccID"] == DBNull.Value ? string.Empty:dataReader["ItmAccID"].ToString();
            _ItmAccDes =dataReader["ItmAccDes"] == DBNull.Value ? string.Empty:dataReader["ItmAccDes"].ToString();
            ...
            _ItmPriceBefore =(decimal?)dataReader["ItmPriceBefore"];
            _ItmPriceAfter = (decimal?)dataReader["ItmPriceAfter"];
            ...
            _ItmVendorCurrRate = (float)dataReader["ItmVendorCurrRate"];
		...
		internal bool Insert(SqlConnection cn, out string msgID)
		{
			...
			{
				cm.CommandType = CommandType.StoredProcedure;
				cm.CommandText = "ARQODetItm_AddUpdate";
		...
		internal bool Delete(SqlConnection cn, Criteria criteria, out string msgID)
		{
			...
			{
				cm.CommandType = CommandType.StoredProcedure;
				cm.CommandText = "ARQODetItm_Delete";
