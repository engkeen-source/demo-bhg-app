...
{
    /// <summary>
    /// Summary description for ARRODetItms.
    /// </summary>
    [Serializable]
    public class ARRODetItms : DataTable
    {
        ...
        public ARRODetItms(SqlConnection cn)
        {
        ...
        internal bool Save(SqlConnection cn, int? headerKey, DataTable dt)
        {
            using (StringWriter swStringWriter = new StringWriter())
            {
                ...
                using (SqlCommand cm = cn.CreateCommand())
                {
                    ...
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "AR_RODetItm_Save";

                    // Datatable as XML format 
                    dt.TableName = "AR_RODetItm";
                    DataSet ds = new DataSet();
                    ds.Tables.Add(dt);

                    //Change Column mapping type to Attribute
                    foreach (DataColumn dc in ds.Tables["AR_RODetItm"].Columns)
                    {
                    ...
                    parameter.ParameterName = "@xmlAR_RODetItm";
        ...
        internal bool Insert(SqlConnection cn, out string msgID)
        {
            ...
            using (StringWriter swStringWriter = new StringWriter())
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "ARRODetItm_AddUpdate";
        ...
        internal bool Delete(SqlConnection cn, Criteria criteria, out string msgID)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "ARRODetItm_Delete";
