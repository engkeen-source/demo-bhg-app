...
{
    /// <summary>
    /// Summary description for CSCPO.
    /// </summary>
    [Serializable]
    public class CSCPO : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(CSCPO_PropertyChanged);
        }
        void CSCPO_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public CSCPO Clone()
        {
            CSCPO objCopy = (CSCPO)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static CSCPO Get(int? docKey)
        {
            CSCPO child = new CSCPO();
            child.Fetch(new Criteria(docKey, 1));
            return child;
        }

        public static CSCPO New()
        {
            CSCPO child = new CSCPO();
            return child;
        }
        ...
        internal static CSCPO Get(IDataReader dr)
        {
            CSCPO child = new CSCPO();
            child.Fetch(dr);
            return child;
        }
        internal static CSCPO Get(SqlConnection cn, Criteria criteria)
        {
            CSCPO child = new CSCPO();
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "CSCPO_AddUpdate";
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "CSCPO_Validation";
