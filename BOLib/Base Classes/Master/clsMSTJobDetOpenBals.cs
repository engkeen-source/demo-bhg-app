...
{
    [Serializable()]
    public class MSTJobDetOpenBals : Csla.BusinessListBase<MSTJobDetOpenBals, MSTJobDetOpenBal>
    {

        #region Factory Methods

        internal MSTJobDetOpenBals()
        {
        }

        internal static MSTJobDetOpenBals New()
        {
            
            MSTJobDetOpenBals obj = new MSTJobDetOpenBals();
            
            return obj;
        }

        internal static MSTJobDetOpenBals Get()
        {
        ...
        private bool Fetch(SqlConnection cn, Criteria criteria)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                {
                    while (dr.Read())
                        this.Add(MSTJobDetOpenBal.Get(dr));
                }
