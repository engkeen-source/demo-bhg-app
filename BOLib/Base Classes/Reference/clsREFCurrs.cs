...
{
    [Serializable()]
    public class REFCurrs : Csla.BusinessListBase<REFCurrs, REFCurr>
    {
        ...
        internal static REFCurrs New()
        {            
            REFCurrs obj = new REFCurrs();           
            return obj;
        }

        internal static REFCurrs Get()
        {
