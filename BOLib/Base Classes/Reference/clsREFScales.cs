...
{
    [Serializable()]
    public class REFScales : Csla.BusinessListBase<REFScales, REFScale>
    {
        ...
        internal static REFScales New()
        {
            REFScales obj = new REFScales();
            return obj;
        }

        internal static REFScales Get()
        {
            REFScales obj = new REFScales();
