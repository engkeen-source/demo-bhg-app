...
{
    [Serializable()]
    public class REFTaxGrps : Csla.BusinessListBase<REFTaxGrps, REFTaxGrp>
    {
        ...
        internal static REFTaxGrps New()
        {
            REFTaxGrps obj = new REFTaxGrps();
            return obj;
        }

        internal static REFTaxGrps Get()
        {
            REFTaxGrps obj = new REFTaxGrps();
