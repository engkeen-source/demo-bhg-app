...
{
    [Serializable()]
    public class REFTerritorys : Csla.BusinessListBase<REFTerritorys, REFTerritory>
    {

        #region Factory Methods

        internal REFTerritorys()
        {
        }

        internal static REFTerritorys New()
        {
            REFTerritorys obj = new REFTerritorys();
            return obj;
        }

        internal static REFTerritorys Get()
        {
            REFTerritorys obj = new REFTerritorys();
