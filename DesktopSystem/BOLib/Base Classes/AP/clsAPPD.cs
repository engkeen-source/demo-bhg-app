...
{
    /// <summary>
    /// Summary description for APPD.
    /// </summary>
    [Serializable]
    public class APPD : Document, INotifyPropertyChanged
    {
        ...
        internal int _PDTransferAPBLDK;
        internal string _PDTransferAPBLID;
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(APPD_PropertyChanged);
        }

        void APPD_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public APPD Clone()
        {
            APPD objCopy = (APPD)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static APPD Get(int? docKey)
        {
            APPD child = new APPD();
        ...
        public int PDTransferAPBLDK
        {
            get
            {
                return this._PDTransferAPBLDK;
            }
            set
            {
                this._PDTransferAPBLDK = value;
                NotifyPropertyChanged("PDTransferAPBLDK");
            }
        }

        public string PDTransferAPBLID
        {
            get
            {
                return this._PDTransferAPBLID;
            }
            set
            {
                this._PDTransferAPBLID = value;
                NotifyPropertyChanged("PDTransferAPBLID");
            } 
        }
        ...
        internal bool Fetch_APPS(SqlConnection cn, Criteria criteria)
        {
            bool retValue = false;
            using (SqlCommand cm = cn.CreateCommand())
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "APPS_CreateDoc";
        ...
        internal static APPD Get(IDataReader dr)
        {
            APPD child = new APPD();
            child.Fetch(dr);
            return child;
        }
        internal static APPD Get(SqlConnection cn, Criteria criteria)
        {
            APPD child = new APPD();
        ...
        internal bool Fetch(IDataReader dataReader, bool CreateDoc)
        {
            if (CreateDoc == false)
            {
                ...
                _PDTransferAPBLDK = dataReader["PDTransferAPBLDK"] == DBNull.Value ? (int)0 : (int)dataReader["PDTransferAPBLDK"];
                _PDTransferAPBLID = dataReader["PDTransferAPBLID"] == DBNull.Value ? (string)null : (string)dataReader["PDTransferAPBLID"];
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "APPD_Validation";
