...
{
    /// <summary>
    /// Summary description for APPOCsgItms.
    /// </summary>
    [Serializable]
    public class APPOCsgItms : DataTable
    {
        #region +++  Constructor  +++
        ...
        public APPOCsgItms(SqlConnection cn)
        {

            this.Fetch(cn, new Criteria(0, 1));
        }     

        public static APPOCsgItms Get(int? DocKey)
        {
        ...
        private static APPOCsgItms Get(Criteria criteria)
        {
            SqlConnection cn = new SqlConnection(Database.BossDemoConnection);
            APPOCsgItms l_reval = new APPOCsgItms();
        ...
        //            cm.CommandType = CommandType.StoredProcedure;
        //            cm.CommandText = "AP_POCsgItm_Save";

        //            // Datatable as XML format 
        //            dt.TableName = "AP_POCsgItm";
        //            DataSet ds = new DataSet();
        //            ds.Tables.Add(dt);

        //            //Change Column mapping type to Attribute
        //            foreach (DataColumn dc in ds.Tables["APPOCsgItm"].Columns)
        //            {
        ...
        //    {
        //        cm.CommandType = CommandType.StoredProcedure;
        //        cm.CommandText = "APPOCsgItm_Delete";
