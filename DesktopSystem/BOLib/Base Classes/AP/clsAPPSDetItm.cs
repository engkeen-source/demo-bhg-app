...
{
    /// <summary>
    /// Summary description for APPSDetItm.
    /// </summary>
    [Serializable]
    public class APPSDetItm : DocSalePur, IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public APPSDetItm Clone()
        {
            APPSDetItm objCopy = (APPSDetItm)this.MemberwiseClone();
            return objCopy;
        }
