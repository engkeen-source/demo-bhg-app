...
{
    /// <summary>
    /// Summary description for APRQ.
    /// </summary>
    [Serializable]
    public class APRQ : Document, INotifyPropertyChanged
    {
        #region +++  Local variables declaration for the class +++
        internal int? _DocGrpKey;
        internal string _DocReply;
            ...
            : base()
        {
            this._DocGrpKey = 0;
            this._DocReply = null;
            base.PropertyChanged += new PropertyChangedEventHandler(APRQ_PropertyChanged);
        }
        void APRQ_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public APRQ Clone()
        {
            APRQ objCopy = (APRQ)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static APRQ Get(int? docKey)
        {
            APRQ child = new APRQ();
        ...
        public string DocReply
        {
            ...
            get
            {
                return this._DocReply;
            }
            set
            {
                this._DocReply = value;
                NotifyPropertyChanged("DocReply");
            }
        }
        ...
        internal static APRQ Get(IDataReader dr)
        {
            APRQ child = new APRQ();
            child.Fetch(dr);
            return child;
        }
        internal static APRQ Get(SqlConnection cn, Criteria criteria)
        {
            APRQ child = new APRQ();
        ...
        internal bool Fetch(IDataReader dataReader)
        {
            ...
            _DocReply = dataReader["DocReply"] == DBNull.Value ? (string)null : (string)dataReader["DocReply"];
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                if (_DocReply == null)
                {
                    cm.Parameters.AddWithValue("@DocReply", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocReply", _DocReply);
                }
                if (_DocStatus == null)
                {
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "APRQ_Validation";
