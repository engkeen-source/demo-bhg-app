...
{
    /// <summary>
    /// Summary description for ARCT.
    /// </summary>
    [Serializable]
    public class ARCT : Document, INotifyPropertyChanged
    {
        ...
        internal decimal _DocApplyARAmtH;
        internal decimal _DocApplyAPAmtH;
            ...
            : base()
        {
            ...
            this._DocCurrKey = 0;
            this._DocCurrRate = 0;
            this._DocApplyARAmtH = 0;
            this._DocApplyAPAmtH = 0;
            this._DocHome = 0;
            this._DocCountryRate = 0;
            this._DocApplyFull = false;
            this._DocConID = string.Empty;
            base.PropertyChanged += new PropertyChangedEventHandler(ARCT_PropertyChanged);
        }
        void ARCT_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public ARCT Clone()
        {
            ARCT objCopy = (ARCT)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static ARCT Get(int? docKey)
        {
            ARCT child = new ARCT();
        ...
        public decimal DocApplyARAmtH
        {

            get
            {
                return this._DocApplyARAmtH;
            }
            set
            {
                this._DocApplyARAmtH = value;
                NotifyPropertyChanged("DocApplyARAmtH");
            }
        }
        public decimal DocApplyAPAmtH
        {

            get
            {
                return this._DocApplyAPAmtH;
            }
            set
            {
                this._DocApplyAPAmtH = value;
                NotifyPropertyChanged("DocApplyAPAmtH");
            }
        }
        ...
        internal static ARCT Get(IDataReader dr)
        {
            ARCT child = new ARCT();
            child.Fetch(dr);
            return child;
        }
        internal static ARCT Get(SqlConnection cn, Criteria criteria)
        {
            ARCT child = new ARCT();
        ...
        internal bool Fetch(IDataReader dataReader)
        {
            ...
            _DocApplyARAmtH = dataReader["DocApplyARAmtH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocApplyARAmtH"];
            _DocApplyAPAmtH = dataReader["DocApplyAPAmtH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocApplyAPAmtH"];
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                if (_DocApplyARAmtH == null)
                {
                    cm.Parameters.AddWithValue("@DocApplyARAmtH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocApplyARAmtH", _DocApplyARAmtH);
                }
                if (_DocApplyAPAmtH == null)
                {
                    cm.Parameters.AddWithValue("@DocApplyAPAmtH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocApplyAPAmtH", _DocApplyAPAmtH);
                }
                if (_DocHome == null)
                {
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "ARCT_Validation";
