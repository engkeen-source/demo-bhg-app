...
{
    /// <summary>
    /// Summary description for ARDO.
    /// </summary>
    [Serializable]
    public class ARDO : Document, INotifyPropertyChanged
    {
        ...
        internal int? _DocDriverKey;
        internal string _DocDriverDes;
        internal decimal _DocTripWeight;
        internal decimal _DocTripWeightRate;
        internal decimal _DocTripWeightAmtH;
        internal decimal _DocTripTotalH;
        internal decimal _DocTripRate;
        internal decimal _DocTripAmtH;
        internal decimal _DocTripClaim1;
        internal decimal _DocTripClaim2;
        internal decimal _DocTripClaim3;
        internal decimal _DocTripClaim4;
        internal decimal _DocTripClaim5;
        internal decimal _DocTripClaim6;
        internal decimal _DocTripExp1;
        internal decimal _DocTripExp2;
        internal decimal _DocTripExp3;
        internal decimal _DocTripExp4;
        internal decimal _DocTripExp5;
        internal decimal _DocTripExp6;
        internal int _DOTransferARIVDK;
        internal string _DOTransferARIVID;
        ...
        internal string _PrintDept = "S";    
        internal bool _IsExportPacking = false;
        internal bool _IsCashSale = false;
        internal bool _IsSelfCollect = false;
            ...
            : base()
        {
            ...
            this._DocCurrKey = 0;
            this._DocCurrRate = 0;
            this.DocHomeSubTotal = 0;
            this.DocHomeTaxTotal = 0;
            this._DocHome = 0;
            this._DocCountryRate = 0;
            this._DocTaxTotalLocal = 0;
            this._DocDriverKey = 0;
            this._DocDriverDes = null;
            this._DocTripWeight = 0;
            this._DocTripWeightRate = 0;
            this._DocTripWeightAmtH = 0;
            this._DocTripTotalH = 0;
            this._DocTripRate = 0;
            this._DocTripAmtH = 0;
            this._DocTripClaim1 = 0;
            this._DocTripClaim2 = 0;
            this._DocTripClaim3 = 0;
            this._DocTripClaim4 = 0;
            this._DocTripClaim5 = 0;
            this._DocTripClaim6 = 0;
            this._DocTripExp1 = 0;
            this._DocTripExp2 = 0;
            this._DocTripExp3 = 0;
            this._DocTripExp4 = 0;
            this._DocTripExp5 = 0;
            this._DocTripExp6 = 0;
            this._DOTransferARIVDK = 0;
            this._DOTransferARIVID = null;
            ...
            this._PrintDept = "S";
            this._IsExportPacking = false;
            this._IsCashSale = false;
            this._IsSelfCollect = false;
            base.PropertyChanged += new PropertyChangedEventHandler(ARDO_PropertyChanged);
        }
        void ARDO_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public ARDO Clone()
        {
            ARDO objCopy = (ARDO)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static ARDO Get(int? docKey)
        {
            ARDO child = new ARDO();
        ...
        public int? DocDriverKey
        {

            get
            {
                return this._DocDriverKey;
            }
            set
            {
                this._DocDriverKey = value;
                NotifyPropertyChanged("DocDriverKey");
            }
        }
        public string DocDriverDes
        {

            get
            {
                return this._DocDriverDes;
            }
            set
            {
                this._DocDriverDes = value;
                NotifyPropertyChanged("DocDriverDes");
            }
        }
        public decimal DocTripWeight
        {

            get
            {
                return this._DocTripWeight;
            }
            set
            {
                this._DocTripWeight = value;
                NotifyPropertyChanged("DocTripWeight");
            }
        }
        public decimal DocTripWeightRate
        {

            get
            {
                return this._DocTripWeightRate;
            }
            set
            {
                this._DocTripWeightRate = value;
                NotifyPropertyChanged("DocTripWeightRate");
            }
        }
        public decimal DocTripWeightAmtH
        {

            get
            {
                return this._DocTripWeightAmtH;
            }
            set
            {
                this._DocTripWeightAmtH = value;
                NotifyPropertyChanged("DocTripWeightAmtH");
            }
        }
        public decimal DocTripTotalH
        {

            get
            {
                return this._DocTripTotalH;
            }
            set
            {
                this._DocTripTotalH = value;
                NotifyPropertyChanged("DocTripTotalH");
            }
        }
        public decimal DocTripRate
        {

            get
            {
                return this._DocTripRate;
            }
            set
            {
                this._DocTripRate = value;
                NotifyPropertyChanged("DocTripRate");
            }
        }
        public decimal DocTripAmtH
        {

            get
            {
                return this._DocTripAmtH;
            }
            set
            {
                this._DocTripAmtH = value;
                NotifyPropertyChanged("DocTripAmtH");
            }
        }
        public decimal DocTripClaim1
        {

            get
            {
                return this._DocTripClaim1;
            }
            set
            {
                this._DocTripClaim1 = value;
                NotifyPropertyChanged("DocTripClaim1");
            }
        }
        public decimal DocTripClaim2
        {

            get
            {
                return this._DocTripClaim2;
            }
            set
            {
                this._DocTripClaim2 = value;
                NotifyPropertyChanged("DocTripClaim2");
            }
        }
        public decimal DocTripClaim3
        {

            get
            {
                return this._DocTripClaim3;
            }
            set
            {
                this._DocTripClaim3 = value;
                NotifyPropertyChanged("DocTripClaim3");
            }
        }
        public decimal DocTripClaim4
        {

            get
            {
                return this._DocTripClaim4;
            }
            set
            {
                this._DocTripClaim4 = value;
                NotifyPropertyChanged("DocTripClaim4");
            }
        }
        public decimal DocTripClaim5
        {

            get
            {
                return this._DocTripClaim5;
            }
            set
            {
                this._DocTripClaim5 = value;
                NotifyPropertyChanged("DocTripClaim5");
            }
        }
        public decimal DocTripClaim6
        {

            get
            {
                return this._DocTripClaim6;
            }
            set
            {
                this._DocTripClaim6 = value;
                NotifyPropertyChanged("DocTripClaim6");
            }
        }
        public decimal DocTripExp1
        {

            get
            {
                return this._DocTripExp1;
            }
            set
            {
                this._DocTripExp1 = value;
                NotifyPropertyChanged("DocTripExp1");
            }
        }
        public decimal DocTripExp2
        {

            get
            {
                return this._DocTripExp2;
            }
            set
            {
                this._DocTripExp2 = value;
                NotifyPropertyChanged("DocTripExp2");
            }
        }
        public decimal DocTripExp3
        {

            get
            {
                return this._DocTripExp3;
            }
            set
            {
                this._DocTripExp3 = value;
                NotifyPropertyChanged("DocTripExp3");
            }
        }
        public decimal DocTripExp4
        {

            get
            {
                return this._DocTripExp4;
            }
            set
            {
                this._DocTripExp4 = value;
                NotifyPropertyChanged("DocTripExp4");
            }
        }
        public decimal DocTripExp5
        {

            get
            {
                return this._DocTripExp5;
            }
            set
            {
                this._DocTripExp5 = value;
                NotifyPropertyChanged("DocTripExp5");
            }
        }
        public decimal DocTripExp6
        {

            get
            {
                return this._DocTripExp6;
            }
            set
            {
                this._DocTripExp6 = value;
                NotifyPropertyChanged("DocTripExp6");
            }
        }
        public int DOTransferARIVDK
        {

            get
            {
                return this._DOTransferARIVDK;
            }
            set
            {
                this._DOTransferARIVDK = value;
                NotifyPropertyChanged("DOTransferARIVDK");
            }
        }
        public string DOTransferARIVID
        {

            get
            {
                return this._DOTransferARIVID;
            }
            set
            {
                this._DOTransferARIVID = value;
                NotifyPropertyChanged("DOTransferARIVID");
            }
        }
        ...
        public string PrintDept
        {
            ...
            get
            {
                return this._PrintDept;
            }
            set
            {
                this._PrintDept = value;
                NotifyPropertyChanged("PrintDept");
            }
        }

        public bool IsExportPacking
        {

            get
            {
                return this._IsExportPacking;
            }
            set
            {
                this._IsExportPacking = value;
                NotifyPropertyChanged("IsExportPacking");
            }
        }
        public bool IsCashSale
        {
            ...
            get
            {
                return this._IsCashSale;
            }
            set
            {
                this._IsCashSale = value;
                NotifyPropertyChanged("IsCashSale");
            }
        }
        public bool IsSelfCollect
        {
            ...
            get
            {
                return this._IsSelfCollect;
            }
            set
            {
                this._IsSelfCollect = value;
                NotifyPropertyChanged("IsSelfCollect");
            }
        }
        ...
        internal class Criteria
        {
            ...
            internal Criteria(int? DocKey)
            {
                _DocKey = DocKey;
                _option = 1;
                _DocCodeKey = (int)GEnum.SystemCode.Delivery_Order;
                _DocID = "";
            }
        ...
        internal static ARDO Get(IDataReader dr)
        {
            ARDO child = new ARDO();
            child.Fetch(dr);
            return child;
        }
        internal static ARDO Get(SqlConnection cn, Criteria criteria)
        {
            ARDO child = new ARDO();
        ...
        internal bool Fetch(IDataReader dataReader, bool CreateDoc)
        {
            try
            {
                if (CreateDoc == false)
                {
                    ...
                    _DOTransferARIVDK = dataReader["DOTransferARIVDK"] == DBNull.Value ? (int)0 : (int)dataReader["DOTransferARIVDK"];
                    _DOTransferARIVID = dataReader["DOTransferARIVID"] == DBNull.Value ? (string)null : (string)dataReader["DOTransferARIVID"];
                ...
                _DocTypeNm = dataReader["DocTypeNm"] == DBNull.Value ? "Delivery Order" : (string)dataReader["DocTypeNm"];
                _DocTypeNm = dataReader["DocTypeNm"] == DBNull.Value ? (string)string.Empty : (string)dataReader["DocTypeNm"];//Added by May on 11-Oct-2016
                ...
                _DocSubTotal = dataReader["DocSubTotal"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocSubTotal"]);
                _DocOverallDisAcc = dataReader["DocOverallDisAcc"] == DBNull.Value ? (int?)null : (int?)dataReader["DocOverallDisAcc"];
                _DocOverallDisRate = dataReader["DocOverallDisRate"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocOverallDisRate"]);
                _DocOverallDisAmt = dataReader["DocOverallDisAmt"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocOverallDisAmt"]);
                _DocTotalAfterDis = dataReader["DocTotalAfterDis"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTotalAfterDis"]);
                _DocTaxGrpKey = dataReader["DocTaxGrpKey"] == DBNull.Value ? (int?)null : (int?)dataReader["DocTaxGrpKey"];
                _DocTaxGrpRate = dataReader["DocTaxGrpRate"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTaxGrpRate"]);
                _DocTaxTotal = dataReader["DocTaxTotal"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTaxTotal"]);
                _DocGrand = dataReader["DocGrand"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocGrand"]);
                _DocCurrKey = dataReader["DocCurrKey"] == DBNull.Value ? (int)0 : (int)dataReader["DocCurrKey"];
                _DocCurrRate = dataReader["DocCurrRate"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocCurrRate"]);
                _DocHomeSubTotal = dataReader["DocHomeSubTotal"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocHomeSubTotal"]);
                _DocHomeTaxTotal = dataReader["DocHomeTaxTotal"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocHomeTaxTotal"]);
                _DocHome = dataReader["DocHome"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocHome"]);
                _DocCountryRate = dataReader["DocCountryRate"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocCountryRate"]);
                _DocTaxTotalLocal = dataReader["DocTaxTotalLocal"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTaxTotalLocal"]);
                _DocDriverKey = dataReader["DocDriverKey"] == DBNull.Value ? (int?)0 : (int?)dataReader["DocDriverKey"];
                _DocDriverDes = dataReader["DocDriverDes"] == DBNull.Value ? (string)null : (string)dataReader["DocDriverDes"];
                _DocTripWeight = dataReader["DocTripWeight"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripWeight"]);
                _DocTripWeightRate = dataReader["DocTripWeightRate"] == DBNull.Value ? 1 : Convert.ToDecimal(dataReader["DocTripWeightRate"]);
                _DocTripWeightAmtH = dataReader["DocTripWeightAmtH"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripWeightAmtH"]);
                _DocTripTotalH = dataReader["DocTripTotalH"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripTotalH"]);
                _DocTripRate = dataReader["DocTripRate"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripRate"]);
                _DocTripAmtH = dataReader["DocTripAmtH"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripAmtH"]);
                _DocTripClaim1 = dataReader["DocTripClaim1"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim1"]);
                _DocTripClaim2 = dataReader["DocTripClaim2"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim2"]);
                _DocTripClaim3 = dataReader["DocTripClaim3"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim3"]);
                _DocTripClaim4 = dataReader["DocTripClaim4"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim4"]);
                _DocTripClaim5 = dataReader["DocTripClaim5"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim5"]);
                _DocTripClaim6 = dataReader["DocTripClaim6"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripClaim6"]);
                _DocTripExp1 = dataReader["DocTripExp1"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp1"]);
                _DocTripExp2 = dataReader["DocTripExp2"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp2"]);
                _DocTripExp3 = dataReader["DocTripExp3"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp3"]);
                _DocTripExp4 = dataReader["DocTripExp4"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp4"]);
                _DocTripExp5 = dataReader["DocTripExp5"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp5"]);
                _DocTripExp6 = dataReader["DocTripExp6"] == DBNull.Value ? (decimal)0 : Convert.ToDecimal(dataReader["DocTripExp6"]);
                ...
                _PrintDept = dataReader["PrintDept"] == DBNull.Value ? (string)string.Empty : (string)dataReader["PrintDept"];
                _IsExportPacking = dataReader["IsExportPacking"] == DBNull.Value ? false : (bool)dataReader["IsExportPacking"];
                _IsCashSale = dataReader["IsCashSale"] == DBNull.Value ? false : (bool)dataReader["IsCashSale"];
                _IsSelfCollect = dataReader["IsSelfCollect"] == DBNull.Value ? false : (bool)dataReader["IsSelfCollect"];
                return true;
            }
            catch (Exception ex)
            {
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                if (_DocDriverKey == null)
                {
                    cm.Parameters.AddWithValue("@DocDriverKey", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocDriverKey", _DocDriverKey);
                }
                if (_DocDriverDes == null)
                {
                    cm.Parameters.AddWithValue("@DocDriverDes", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocDriverDes", _DocDriverDes);
                }
                if (_DocTripWeight == null)
                {
                    cm.Parameters.AddWithValue("@DocTripWeight", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripWeight", _DocTripWeight);
                }
                if (_DocTripWeightRate == null)
                {
                    cm.Parameters.AddWithValue("@DocTripWeightRate", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripWeightRate", _DocTripWeightRate);
                }
                if (_DocTripWeightAmtH == null)
                {
                    cm.Parameters.AddWithValue("@DocTripWeightAmtH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripWeightAmtH", _DocTripWeightAmtH);
                }
                if (_DocTripTotalH == null)
                {
                    cm.Parameters.AddWithValue("@DocTripTotalH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripTotalH", _DocTripTotalH);
                }
                if (_DocTripRate == null)
                {
                    cm.Parameters.AddWithValue("@DocTripRate", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripRate", _DocTripRate);
                }
                if (_DocTripAmtH == null)
                {
                    cm.Parameters.AddWithValue("@DocTripAmtH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripAmtH", _DocTripAmtH);
                }
                if (_DocTripClaim1 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim1", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim1", _DocTripClaim1);
                }
                if (_DocTripClaim2 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim2", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim2", _DocTripClaim2);
                }
                if (_DocTripClaim3 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim3", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim3", _DocTripClaim3);
                }
                if (_DocTripClaim4 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim4", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim4", _DocTripClaim4);
                }
                if (_DocTripClaim5 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim5", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim5", _DocTripClaim5);
                }
                if (_DocTripClaim6 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripClaim6", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripClaim6", _DocTripClaim6);
                }
                if (_DocTripExp1 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp1", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp1", _DocTripExp1);
                }
                if (_DocTripExp2 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp2", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp2", _DocTripExp2);
                }
                if (_DocTripExp3 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp3", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp3", _DocTripExp3);
                }
                if (_DocTripExp4 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp4", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp4", _DocTripExp4);
                }
                if (_DocTripExp5 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp5", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp5", _DocTripExp5);
                }
                if (_DocTripExp6 == null)
                {
                    cm.Parameters.AddWithValue("@DocTripExp6", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTripExp6", _DocTripExp6);
                }
                if (_DocStatus == null)
                {
                ...
                if (_DOTransferARIVDK == null)
                {
                    cm.Parameters.AddWithValue("@DOTransferARIVDK", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DOTransferARIVDK", _DOTransferARIVDK);
                }
                if (_DOTransferARIVID == null)
                {
                    cm.Parameters.AddWithValue("@DOTransferARIVID", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DOTransferARIVID", _DOTransferARIVID);
                }
                if (_CreateDate == null)
                {
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "ARDO_Validation";
