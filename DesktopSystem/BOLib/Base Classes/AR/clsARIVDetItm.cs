...
{
    /// <summary>
    /// Summary description for ARIVDetItm.
    /// </summary>
    [Serializable]
    public class ARIVDetItm : DocSalePur, IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        public ARIVDetItm Clone()
        {
            ARIVDetItm objCopy = (ARIVDetItm)this.MemberwiseClone();
            return objCopy;
        }
