...
{
    /// <summary>
    /// Summary description for GLDP.
    /// </summary>
    [Serializable]
    public class GLDP : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(GLDP_PropertyChanged);
        }
        void GLDP_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public GLDP Clone()
        {
            GLDP objCopy = (GLDP)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static GLDP Get(int? docKey)
        {
            GLDP child = new GLDP();
        ...
        public decimal DocGainAmtH
        {

            get
            {
                return this._DocGainAmtH;
            }
            set
            {
                this._DocGainAmtH = value;
                NotifyPropertyChanged("DocGainAmtH");
            }
        }
        ...
        internal static GLDP Get(IDataReader dr)
        {
            GLDP child = new GLDP();
            child.Fetch(dr);
            return child;
        }
        internal static GLDP Get(SqlConnection cn, Criteria criteria)
        {
            GLDP child = new GLDP();
        ...
        internal bool Fetch(IDataReader dataReader)
        {
            ...
            _DocAccGainKey = dataReader["DocAccGainKey"] == DBNull.Value ? (int?)null : (int?)dataReader["DocAccGainKey"];
            _DocGainAmtH = dataReader["DocGainAmtH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocGainAmtH"];
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                if (_DocGainAmtH == null)
                {
                    cm.Parameters.AddWithValue("@DocGainAmtH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocGainAmtH", _DocGainAmtH);
                }
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "GLDP_Validation";
