...
{
    /// <summary>
    /// Summary description for GLJNL.
    /// </summary>
    [Serializable]
    public class GLJNL : Document, INotifyPropertyChanged
    {
        #region +++  Local variables declaration for the class +++
        internal int? _DocTranGrpKey;
        internal int _DocGrpKey;
        internal decimal _DocTotalCreditH;
        internal decimal _DocTotalDebitH;
        internal decimal _DocTotalDebitGSTH;
        internal decimal _DocTotalCreditGSTH;
            ...
            : base()
        {
            ...
            this._DocGrpKey = 0;
            this._DocTotalCreditH = 0;
            this._DocTotalDebitH = 0;
            base.PropertyChanged += new PropertyChangedEventHandler(GLJNL_PropertyChanged);
        }
        void GLJNL_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public GLJNL Clone()
        {
            GLJNL objCopy = (GLJNL)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static GLJNL Get(int? docKey)
        {
            GLJNL child = new GLJNL();
            child.Fetch(new Criteria((int)GEnum.SystemCode.Journal, docKey, 1));
            return child;
        }

        public static GLJNL New()
        {
            GLJNL child = new GLJNL();
            return child;
        }
        ...
        public decimal DocTotalCreditH
        {

            get
            {
                return this._DocTotalCreditH;
            }
            set
            {
                this._DocTotalCreditH = value;
                NotifyPropertyChanged("DocTotalCreditH");
            }
        }

        public decimal DocTotalDebitH
        {

            get
            {
                return this._DocTotalDebitH;
            }
            set
            {
                this._DocTotalDebitH = value;
                NotifyPropertyChanged("DocTotalDebitH");
            }
        }

        public decimal DocTotalDebitGSTH
        {

            get
            {
                return this._DocTotalDebitGSTH;
            }
            set
            {
                this._DocTotalDebitGSTH = value;
                NotifyPropertyChanged("DocTotalDebitGSTH");
            }
        }

        public decimal DocTotalCreditGSTH
        {

            get
            {
                return this._DocTotalCreditGSTH;
            }
            set
            {
                this._DocTotalCreditGSTH = value;
                NotifyPropertyChanged("DocTotalCreditGSTH");
            }
        }
        ...
        internal static GLJNL Get(IDataReader dr)
        {
            GLJNL child = new GLJNL();
            child.Fetch(dr);
            return child;
        }
        internal static GLJNL Get(SqlConnection cn, Criteria criteria)
        {
            GLJNL child = new GLJNL();
        ...
        internal bool Fetch(IDataReader dataReader)
        {
            ...
            _DocTotalCreditH = dataReader["DocTotalCreditH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocTotalCreditH"];
            _DocTotalDebitH = dataReader["DocTotalDebitH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocTotalDebitH"];

            //_DocTotalCreditGSTH = dataReader["DocTotalCreditH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocTotalCreditGSTH"];
            //_DocTotalDebitGSTH = dataReader["DocTotalDebitH"] == DBNull.Value ? (decimal)0 : (decimal)dataReader["DocTotalDebitGSTH"];
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "GLJNL_AddUpdate";
                ...
                if (_DocTotalCreditH == null)
                {
                    cm.Parameters.AddWithValue("@DocTotalCreditH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTotalCreditH", _DocTotalCreditH);
                }
                if (_DocTotalDebitH == null)
                {
                    cm.Parameters.AddWithValue("@DocTotalDebitH", DBNull.Value);
                }
                else
                {
                    cm.Parameters.AddWithValue("@DocTotalDebitH", _DocTotalDebitH);
                }

                //if (_DocTotalCreditGSTH == null)
                //{
                //    cm.Parameters.AddWithValue("@DocTotalCreditGSTH", DBNull.Value);
                //}
                //else
                //{
                //    cm.Parameters.AddWithValue("@DocTotalCreditGSTH", _DocTotalCreditGSTH);
                //}
                //if (_DocTotalDebitGSTH == null)
                //{
                //    cm.Parameters.AddWithValue("@DocTotalDebitGSTH", DBNull.Value);
                //}
                //else
                //{
                //    cm.Parameters.AddWithValue("@DocTotalDebitGSTH", _DocTotalDebitGSTH);
                //}
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "GLJNL_Validation";
