...
{
    /// <summary>
    /// Summary description for INADJ.
    /// </summary>
    [Serializable]
    public class INADJ : Document, INotifyPropertyChanged
    {
            ...
            : base()
        {
            ...
            base.PropertyChanged += new PropertyChangedEventHandler(INADJ_PropertyChanged);
        }
        void INADJ_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
        ...
        public INADJ Clone()
        {
            INADJ objCopy = (INADJ)this.MemberwiseClone();
            objCopy._isDirty = false;
            return objCopy;
        }
        public static INADJ Get(int? docKey)
        {
            INADJ child = new INADJ();
            child.Fetch(new Criteria(docKey, 1));
            return child;
        }

        public static INADJ New()
        {
            INADJ child = new INADJ();
            return child;
        }
        ...
        internal static INADJ Get(IDataReader dr)
        {
            INADJ child = new INADJ();
            child.Fetch(dr);
            return child;
        }
        internal static INADJ Get(SqlConnection cn, Criteria criteria)
        {
            INADJ child = new INADJ();
        ...
        internal bool Fetch(IDataReader dataReader)
			{               
				...
				_ApproveDate = dataReader["ApproveDate"] == DBNull.Value ? Convert.ToDateTime("01-jan-1900 12:00:00 am") : (DateTime?)dataReader["ApproveDate"];				
                ...
                _ApprovalStatus = dataReader["ApprovalStatus"] == DBNull.Value ? (string)null : (string)dataReader["ApprovalStatus"];
        ...
        internal bool Insert(SqlConnection cn)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "INADJ_AddUpdate";
        ...
        internal bool Validation(SqlConnection cn, Criteria criteria, bool isNew)
        {
            ...
            try
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "INADJ_Validation";
