...
{
    [Serializable()]
    public class REFIDFormats : Csla.BusinessListBase<REFIDFormats, REFIDFormat>
    {

        #region Factory Methods

        internal REFIDFormats()
        {
        }

        internal static REFIDFormats New()
        {

            REFIDFormats obj = new REFIDFormats();           
            return obj;
        }

        internal static REFIDFormats Get()
        {           
            REFIDFormats obj = new REFIDFormats();
