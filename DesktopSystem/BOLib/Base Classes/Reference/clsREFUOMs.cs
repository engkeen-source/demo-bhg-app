...
{
    [Serializable()]
    public class REFUOMs : Csla.BusinessListBase<REFUOMs, REFUOM>
    {
        ...
        internal static REFUOMs New()
        {
            REFUOMs obj = new REFUOMs();
            return obj;
        }

        internal static REFUOMs Get()
        {
            REFUOMs obj = new REFUOMs();
