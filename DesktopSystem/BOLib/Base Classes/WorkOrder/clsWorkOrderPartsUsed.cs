...
{
    [Serializable()]
    public class WorkOrderPartsUsed : DataTable
    {
         #region +++  Constructor  +++

        public WorkOrderPartsUsed()
        {
        ...
        public WorkOrderPartsUsed(SqlConnection cn)
        {
        ...
        internal bool Fetch(SqlConnection cn, Criteria criteria)
        {
            using (SqlCommand cm = cn.CreateCommand())
            {
                ...
                cm.CommandText = "WOPartsUsed_Get";
        ...
        internal bool Insert(SqlConnection cn, out string msgID)
        {
            ...
            foreach (DataRow dr in this.Rows)
            {
                ...
                {
                    cm.CommandType = CommandType.StoredProcedure;
                    cm.CommandText = "WOPartsUsed_AddUpdate";
                    ...
                    cm.Parameters.AddWithValue("@ItemKey", dr["ItemKey"]);

                    cm.Parameters.AddWithValue("@ItemDes", dr["ItemDes"]);

                    cm.Parameters.AddWithValue("@Qty", dr["Qty"]);

                    cm.Parameters.AddWithValue("@Price", dr["Price"]);
        ...
        internal bool Delete(SqlConnection cn, Criteria criteria, out string msgID)
        {
            ...
            {
                cm.CommandType = CommandType.StoredProcedure;
                cm.CommandText = "WOPartsUsed_Delete";
